...
export const subscribeVideosActionTypes = {
  SUBSCRIBE_VIDEOS_REQUEST: "SUBSCRIBE_VIDEOS_REQUEST",
  SUBSCRIBE_VIDEOS_SUCCESS: "SUBSCRIBE_VIDEOS_SUCCESS",
  SUBSCRIBE_VIDEOS_FAIL: "SUBSCRIBE_VIDEOS_FAIL",
};

export const channelVideosActionTypes = {
